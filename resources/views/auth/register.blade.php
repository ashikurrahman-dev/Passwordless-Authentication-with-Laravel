        ...
        <form action="{{ route('auth.register') }}" method="post"
            ...
            <div class="space-y-2">
                ...
                <input type="name" name="name" id="name" value="{{ old('name') }}"
                    ...
                    class="bg-slate-50 px-2 py-3  w-full rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500 @error('name') border-2 border-red-500 @enderror">
                @error('name')
            ...
            <button type="submit"
                class="w-full bg-teal-500 hover:bg-rose-600 text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-rose-400">Register</button>
